Welcome to OpenIdentityServer (latest)
=============================================

.. image:: images/logo.png
   :align: center

OpenIdentityServer is an OpenID Connect and OAuth 2.0 framework for ASP.NET Core.
...
.. warning:: 
   ...
   OpenIdentityServer will be maintained with security updates until November 2022. 
