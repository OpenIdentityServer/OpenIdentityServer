...
To see the full list, please go to `OpenIdentityServer Quickstarts Overview <https://identityserver4.readthedocs.io/en/latest/quickstarts/0_overview.html>`_
...
(see the full file `here <https://github.com/2pNza/OpenIdentityServer/blob/main/samples/Quickstarts/1_ClientCredentials/src/IdentityServer/Config.cs>`_).
...
^^^^^^^^^^^^^^^^^^^^^^^^^^
Loading the resource and client definitions happens in `Startup.cs <https://github.com/2pNza/OpenIdentityServer/blob/main/samples/Quickstarts/1_ClientCredentials/src/IdentityServer/Startup.cs>`_ - update the code to look like this::
...
Configure the API application to run on ``https://localhost:6001`` only. You can do this by editing the `launchSettings.json <https://github.com/2pNza/OpenIdentityServer/blob/main/samples/Quickstarts/1_ClientCredentials/src/Api/Properties/launchSettings.json>`_ file inside the Properties folder. Change the application URL setting to be::
...
(full file can be found `here <https://github.com/2pNza/OpenIdentityServer/blob/main/samples/Quickstarts/1_ClientCredentials/src/Client/Program.cs>`_)
