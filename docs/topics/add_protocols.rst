...
OpenIdentityServer allows adding support for other protocols besides the built-in 
...
A sample for adding WS-Federation support can be found `here <https://github.com/2pNza/OpenIdentityServer.WsFederation>`_.
