...
or use the `identity server authentication handler <https://github.com/2pNza/OpenIdentityServer.AccessTokenValidation>`_ which can validate both JWTs and reference tokens.
