...
Co-hosting OpenIdentityServer and a Web API
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
OpenIdentityServer samples for MongoDB
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
* OpenIdentityServer-mongo: Similar to Quickstart EntityFramework configuration but using MongoDB for the configuration data.
* OpenIdentityServer-mongo-AspIdentity: More elaborated sample based on uses ASP.NET Identity for identity management that uses using MongoDB for the configuration data

https://github.com/souzartn/OpenIdentityServer.Samples.Mongo
...
https://github.com/BenjaminAbt/Samples.AspNetCore-OpenIdentityServer


Securing a Node API with tokens from OpenIdentityServer using JWKS
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
